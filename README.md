...
2. Open `renderer_gpu.html` in a browser. It should show that it is connected to the code runnin the terminal above.
3. Edit or touch `test.forth`
4. Watch for changes in the browser window.

# Usage CPU Version
1. Open a terminal and run `./run_cpu.bash`.
2. Open `renderer_cpu.html` in a browser. It should show that it is connected to the code runnin the terminal above.
3. Edit or touch `test.forth`
4. Watch for changes in the browser window.
